...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent() {
            ...
            sprite0 = Content.Load<Texture2D>(@"graphics/1058020201");
            sprite1 = Content.Load<Texture2D>(@"graphics/1059010201");
            sprite2 = Content.Load<Texture2D>(@"graphics/1063010201");

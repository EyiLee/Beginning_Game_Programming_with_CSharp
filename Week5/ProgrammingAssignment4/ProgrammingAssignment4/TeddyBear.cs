...
namespace ProgrammingAssignment4
{
    ...
    public class TeddyBear
    {
        ...
        public TeddyBear(Texture2D sprite, Vector2 location)
        {
            ...
            drawRectangle = new Rectangle((int)location.X - sprite.Width / 2, (int)location.Y - sprite.Width / 2, sprite.Width, sprite.Height);
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (collecting)
            {
                location += velocity * 1000 / gameTime.ElapsedGameTime.Milliseconds;
        ...
        public void SetTarget(Vector2 target)
        {
            ...
            float velocityX = target.X - location.X;
            float velocityY = target.Y - location.Y;

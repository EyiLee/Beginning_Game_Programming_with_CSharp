...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
            ...
            foreach (TeddyBear bear in bears)
            {
                foreach (Projectile projectile in projectiles)
                {
                        ...
                        projectile.Active)
                    {
                        ...
                        Rectangle collisionRectangle = Rectangle.Intersect(bear.CollisionRectangle, projectile.CollisionRectangle);
                        explosions.Add(new Explosion(explosionSpriteStrip, collisionRectangle.Center.X, collisionRectangle.Center.Y));
                    }
                }
            }
        ...
        private void SpawnBear()
        {
            ...
            // create new bear
            TeddyBear newBear = new TeddyBear(Content, @"graphics/teddybear", x, y, velocity, null, null);
